...
def put_label_and_text_area():
    ...
    title.config(text="Please enter your input:")
...
def convert(convert):
    ...
    if convert == "1. decimal to binary conversion":
        ...
        result.config(text="could not calculate result")
        return
...
button1 = tk.Button(
    button_frame, text="1. decimal to binary conversion", command=lambda: on_button_click("1. decimal to binary conversion")
)
button1.grid(row=0, column=0, padx=10, pady=10)

button2 = tk.Button(
    button_frame,
    text="2. decimal to hexadecimal conversion",
    command=lambda: on_button_click("2. decimal to hexadecimal conversion"),
)
button2.grid(row=0, column=1, padx=10, pady=10)

button3 = tk.Button(
    button_frame, text="3. binary to decimal conversion", command=lambda: on_button_click("3. binary to decimal conversion")
)
button3.grid(row=1, column=0, padx=10, pady=10)

button4 = tk.Button(
    button_frame,
    text="4. hexadecimal to decimal conversion",
    command=lambda: on_button_click("4. hexadecimal to decimal conversion"),
)
button4.grid(row=1, column=1, padx=10, pady=10)

button5 = tk.Button(
    button_frame,
    text="5. hexadecimal to binary conversion",
    command=lambda: on_button_click("5. hexadecimal to binary conversion"),
)
button5.grid(row=2, column=0, padx=10, pady=10)

button6 = tk.Button(
    button_frame,
    text="6. binary to hexadecimal conversion",
    command=lambda: on_button_click("6. binary to hexadecimal conversion"),
)
button6.grid(row=2, column=1, padx=10, pady=10)
